...
// tópico mqtt com prefixos para garantir que seja único no servidor que
// utilizamos porque test.mosquitto.org é público
...
void atualizarTopico(int estado) {
  ...
  // tornando suficiente publicar somente quando a lâmpada de fato muda de
  // estado ao invés de periodicamente
  if (estado) {
...
int mqttConnect() {
  ...
  // A linha seguinte configura o broker mqtt para que publique a seguinte
  // mensagem caso este cliente se desconecte abruptamente:
